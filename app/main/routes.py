...
def index():
    ...
    next_url = url_for("main.index", post=posts.has_next) if posts.has_next else None
    prev_url = url_for("main.index", post=posts.has_prev) if posts.has_prev else None
